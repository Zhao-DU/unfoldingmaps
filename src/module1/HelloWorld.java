...
//git_testing comment 2020/04/22
 ...
 * 
 * @author Zhao Du Date: October 25th 2020 
 */
...
public class HelloWorld extends PApplet {
	...
	public void setup() {
		...
		// Places map2 such that it is on the right side of map1
		map2 = new UnfoldingMap(this, 420, 50, 350, 500, provider);

		// center map2 at Montreal, Canada
		map2.zoomAndPanTo(zoomLevel, new Location(45.51f, -73.56f));
	...
	/** Draw the Applet window for BOTH maps */
	public void draw() {
		map1.draw();
		map2.draw();
	}
