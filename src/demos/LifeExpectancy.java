...
public class LifeExpectancy extends PApplet {
	...
	public void setup() {
		size(800, 600, OPENGL);
		map = new UnfoldingMap(this, 50, 50, 700, 500, new EsriProvider.WorldTopoMap());
		...
		// ID row is thrown into feature.id, and the poglygonshaper is 
	...
	//Hashmap is the equivalent of a python dictionary 
